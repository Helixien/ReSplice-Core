...
namespace ReSpliceCore
{
    ...
    public class Building_XenogermDuplicator : Building_Processor
    {
        ...
        public override SoundDef SustainerDef => RS_DefOf.RS_XenoGermDuplicator_Ambience;
        ...
        public override IEnumerable<Gizmo> GetGizmos()
        {
            ...
            if (Faction == Faction.OfPlayer)
            {
                ...
                {
                    defaultLabel = "RS.DuplicateXenogerm".Translate(),
                    defaultDesc = "RS.DuplicateXenogermDesc".Translate(),
                    icon = InsertXenogerm,
                    action = delegate
                    {
                        ...
                        foreach (var xenogerm in allXenogerms)
                        {
                            floatList.Add(new FloatMenuOption(xenogerm.LabelCap, delegate
                            {
                                ...
                                {
                                    Find.WindowStack.Add(new Dialog_MessageBox("RS.NotEnoughArchiteCapsulesLoaded".Translate(),
                ...
                {
                    separateGene.Disable("RS.DuplicatorWorking".Translate());
                }
                if (Powered is false)
                {
                ...
                if (StoredXenogerm != null || xenogermToDuplicate != null)
                {
                    ...
                    {
                        defaultLabel = "RS.CancelXenogermDuplication".Translate(),
                        defaultDesc = "RS.CancelXenogermDuplicationDesc".Translate(),
        ...
        public override string GetInspectString()
        {
            ...
            if (StoredXenogerm != null)
            {
                ...
                sb.AppendLine("RS.DuplicationProgress".Translate(progress.ToStringPercent()));
                sb.AppendLine("RS.ContainsXenogerm".Translate(StoredXenogerm.Label));
            }
        ...
        protected override void FinishJob()
        {
            ...
            GenPlace.TryPlaceThing(newXenogerm, Position, Map, ThingPlaceMode.Near,
                extraValidator: (IntVec3 x) => x.GetFirstThing<Building_XenogermDuplicator>(this.Map) is null);
            GenPlace.TryPlaceThing(storedXenogerm, Position, Map, ThingPlaceMode.Near,
                extraValidator: (IntVec3 x) => x.GetFirstThing<Building_XenogermDuplicator>(this.Map) is null);
            Messages.Message("RS.FinishedXenogermDuplicationMessage".Translate(), new List<Thing>
                        {
